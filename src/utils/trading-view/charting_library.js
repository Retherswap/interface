/* eslint-disable no-unused-expressions, no-undef, no-restricted-globals, strict, no-sequences, no-useless-escape, no-use-before-define, no-use-before-define */
!(function (t, e) {
  ...
  const r = class {
    constructor(t) {
      ...
      (null === (i = t.overrides) || void 0 === i ? void 0 : i['mainSeriesProperties.priceAxisProperties.lockScale']) &&
        (console.warn(
      ...
      'dark' === (null !== (s = this._options.theme) && void 0 !== s ? s : 'light').toLowerCase() &&
        ...
        this._options.debug &&
          (o || ((o = !0), console.log('Using CL v27.003 (internal id d1c8c1a5 @ 2024-03-14T16:58:45.558Z)'))),
        this._create();
    }
    setDebugMode(t) {
          ...
          l = `\n${(function (t, e, n) {
            ...
            for (const s of t)
              s.endsWith('.js')
                ...
                : s.endsWith('.css') &&
                  o.push(`<link type="text/css" href="${e ? s.replace(/\.css$/i, '.rtl.css') : s}" rel="stylesheet"/>`);
            return [...i, ...o].join('\n');
          })(s, 'rtl' === a.dir, r)}\n`;

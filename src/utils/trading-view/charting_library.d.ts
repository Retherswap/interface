...
export interface StandardFormattersDependenciesMapping {
  ...
  [StandardFormatterName.Symbol]: [string, string, string] | [string, string];
  [StandardFormatterName.Side]: [string];
  [StandardFormatterName.PositionSide]: [string];
  [StandardFormatterName.Text]: string[];
  [StandardFormatterName.Type]: [string, string, string];
  [StandardFormatterName.FormatPrice]: [string];
  [StandardFormatterName.FormatPriceForexSup]: [string];
  [StandardFormatterName.Status]: [string];
  [StandardFormatterName.Date]: [string];
  [StandardFormatterName.LocalDate]: [string];
  [StandardFormatterName.DateOrDateTime]: [string];
  [StandardFormatterName.LocalDateOrDateTime]: [string];
  [StandardFormatterName.Fixed]: [string];
  [StandardFormatterName.FixedInCurrency]: [string, string];
  [StandardFormatterName.VariablePrecision]: [string];
  [StandardFormatterName.Pips]: [string];
  [StandardFormatterName.IntegerSeparated]: [string];
  [StandardFormatterName.FormatQuantity]: [string];
  [StandardFormatterName.Profit]: [string];
  [StandardFormatterName.ProfitInInstrumentCurrency]: [string, string];
  [StandardFormatterName.Percentage]: [string];
  [StandardFormatterName.MarginPercent]: [string];

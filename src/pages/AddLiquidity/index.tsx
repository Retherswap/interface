...
import { Currency, ETHER, TokenAmount } from '@retherswap/sdk';
    ...
    return noLiquidity ? (
      <AutoColumn gap="20px">
        <LightCard mt="20px" borderRadius="20px">
          <RowFlat>
            <Text fontSize="20px" fontWeight={500} lineHeight="20px" marginRight={10}>
  ...
  const handleCurrencyBSelect = useCallback(
    (currencyB: Currency) => {
      ...
      if (currencyIdA === newCurrencyIdB) {
        ...
        history.push(`/add/${currencyIdA ? currencyIdA : 'HYPRA'}/${newCurrencyIdB}`);
      }
    },

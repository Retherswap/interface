...
import { TokenAmount, JSBI } from '@retherswap/sdk';
import { useActiveWeb3React } from '../../hooks';
import { AVERAGE_BLOCK_TIME_IN_SECS, COMMON_CONTRACT_NAMES, RETHER, ZERO_ADDRESS } from '../../constants';
      ...
      <ProposalInfo gap="lg" justify="start">
        ...
        <AutoColumn gap="10px" style={{ width: '100%' }}>
          ...
          <RowBetween>
            <Fonts.main>
              {endDate && endDate < now
                ? 'Voting ended ' + (endDate && endDate.toLocaleString())
                : proposalData
                ? 'Voting ends approximately ' + (endDate && endDate.toLocaleString())
                : ''}
            </Fonts.main>
          </RowBetween>

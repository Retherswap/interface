...
import DEFAULT_TOKEN_LIST from '@retherswap/default-token-list';
import { ChainId, Token } from '@retherswap/sdk';
import { Tags, TokenInfo, TokenList } from '@retherswap/token-lists';
...
function combineMaps(map1: TokenAddressMap, map2: TokenAddressMap): TokenAddressMap {
  return {
    ...
    622277: { ...map1[622277], ...map2[622277] },
  };
}
